...
class zp_flickr_widget extends WP_Widget {
	...
	function __construct(  ) {
		...
		/* Widget settings. */
		$widget_ops = array(  'classname' => 'zp_flickr_widget', 'description' => __( 'A widget that displays your Flickr photos.', 'single' )  );
		/* Create the widget. */
		parent::__construct(  'zp_flickr_widget', __( 'Flickr Photos', 'single' ), $widget_ops  );
	}
	/* ---------------------------- */
	/* ------- Display Widget -------- */
	/* ---------------------------- */
	...
	function form(  $instance  ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id(  'title'  ); ?>"><?php _e( 'Title:', 'single' ) ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id(  'title'  ); ?>" name="<?php echo $this->get_field_name(  'title'  ); ?>" value="<?php echo $instance['title']; ?>" />
		</p>
		<!-- Flickr ID: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id(  'flickrID'  ); ?>"><?php _e( 'Flickr ID:', 'single' ) ?> ( <a href="http://idgettr.com/">idGettr</a> )</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id(  'postcount'  ); ?>"><?php _e( 'Number of Photos:', 'single' ) ?></label>
		...
		<!-- Type: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id(  'type'  ); ?>"><?php _e( 'Type ( user or group ):', 'single' ) ?></label>
		...
		<!-- Display: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id(  'display'  ); ?>"><?php _e( 'Display ( random or latest ):', 'single' ) ?></label>
