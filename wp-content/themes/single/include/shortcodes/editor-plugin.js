...
var shortcodeButton=[
...

		{
			...
			fields:[{id:'size' , name:'Size',values:['one-half','one-third','two-third','one-fourth','three-fourth'] },{id:'last', name:'Last',values:['true','false']},{id:'title', name:'Title'},{id:'icon', name:'Icon'}, {id:'content', name:'Content', textarea: true}, {id:'service_button', name:'Button',values:['true','false']},{id:'service_link', name:'Link'}, {id:'service_title', name:'Title'}, {id:'service_size', name:'Size', values:['small','medium','large']},{id:'service_color', name:'Color', values:['grey','blue','red','black','orange','green']},{id:'service_rounded', name:'Rounded', values:['true','false']} ],
			...
			var btn_tag = '';	
				...
				if(obj.service_button == 'true'){


					btn_tag = 'name="'+obj.service_title+'" link="'+obj.service_link+'" btnsize="'+obj.service_size+'" color="'+obj.service_color+'" rounded="'+obj.service_rounded+'"';
				...
				html='[servicebox size="'+obj.size+'" last="'+obj.last+'" title="'+obj.title+'" icon="'+obj.icon+'" '+btn_tag+']'+obj.content+'[/servicebox]';
...

		{
			...
			fields:[{id:'size' , name:'Size',values:['one-half','one-third','one-fourth'] },{id:'last', name:'Last',values:['true','false']},{id:'name', name:'Name'},{id:'title', name:'Title'},{id:'icon', name:'Icon'}, {id:'content', name:'Content', textarea: true}, {id:'facebook', name:'Facebook'}, {id:'twitter', name:'Twitter'}, {id:'gmail', name:'Gmail'}, {id:'skype', name:'Skype'}, {id:'youtube', name:'Youtube'}, {id:'linkedin', name:'LinkedIn'}],
			...
			var html='';
				...
				html='[team size="'+obj.size+'" last="'+obj.last+'" name="'+obj.name+'" title="'+obj.title+'" icon="'+obj.icon+'"  facebook="'+obj.facebook+'"  twitter="'+obj.twitter+'"  gmail="'+obj.gmail+'"   skype="'+obj.skype+'"   youtube="'+obj.youtube+'"   linkedin="'+obj.linkedin+'"  ]'+obj.content+'[/team]';
...

		{
			...
			generateHtml:function(obj){
				...
				return '[portfolio type="filter" columns="3" items="6"][/portfolio]';
...

		{
			...
			generateHtml:function(obj){
				...
				return '[recent_blog title="Latest Blog" desc="Your Blog Description" link="#" button_name="Read More" items="6" category="uncategorized"][/recent_blog]';
